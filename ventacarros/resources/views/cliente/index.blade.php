            ...
            <tbody>
                @foreach ($clientes as $cliente)
                    <tr class="">
                        ...
                        <td>
                            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editarcliente{{$cliente->id_cliente}}"><i class="fa-solid fa-pen-to-square"></i></button>
                            <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#eliminarcliente{{$cliente->id_cliente}}"><i class="fa-solid fa-trash-can"></i></button>
                        </td>
                    </tr>
